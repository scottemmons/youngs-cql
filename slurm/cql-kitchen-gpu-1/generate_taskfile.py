env_and_steps = [
    "--env kitchen-mixed-v0 --max_traj_length 280",
    "--env kitchen-partial-v0 --max_traj_length 280",
    "--env kitchen-complete-v0 --max_traj_length 280",
]
num_seeds = 5
